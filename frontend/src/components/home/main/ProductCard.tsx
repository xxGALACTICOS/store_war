...
////////////////////////////////////////////
const ProdName = 'AirPods'
const ProdRating = 3.7
const ProdVoters = 100
const ProdPrice = 599.50
////////////////////////////////////////////
const ProductCard = () => {
    return (
        <div className='m-2 h-70 rounded-lg shadow-md cursor-pointer'>
            <div className="w-full flex justify-center items-center">
                <img src={ProdImage} alt={ProdName} className='h-40 object-cover rounded-t-lg' />
            </div>
            <div className="ml-5">
                <p className='mt-3 text-xl font-bold truncate w-full'>{ProdName}</p>
                <div className="flex">
                    <StarIcon className='size-5 mr-1' />
                    <p className='font-bold pr-1'>{ProdRating}</p>
